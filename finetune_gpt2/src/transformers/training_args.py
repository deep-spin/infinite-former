...
class TrainingArguments:
    ...
    learning_rate_ltm: float = field(default=.00025)
    kl_regularizer: bool = field(default=False)
    kl_m: float = field(default=None)
    compressive: bool = field(default=False)
    ...
    logging_steps: int = field(default=2000, metadata={"help": "Log every X updates steps."})
